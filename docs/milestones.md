...
| L5 lawful startup/menu | OPEN — first original startup phase passes J39; recovered loading-scene handoff next | Observed initialization, truthful services, optional no-audio lifecycle, Android profile/content roots, original menu navigation | L4/L9 foundation; entitlement/native lifecycle |
