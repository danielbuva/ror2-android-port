...
| L5 lawful startup/menu | OPEN — bounded component methods and first postprocessing volume pass through J46; second volume next | Observed initialization, truthful services, optional no-audio lifecycle, Android profile/content roots, original menu navigation | L4/L9 foundation; entitlement/native lifecycle |
...
| L9 profile | OPEN — isolated filesystem candidate passes J39; real saves unproven | Fresh Android-only foundation before L5; cold reload, interrupted write, update retention, backup/restore by L8 | Path audit; host Steam profile immutable |
