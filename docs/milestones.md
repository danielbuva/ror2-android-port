...
| L5 lawful startup/menu | OPEN — early no-audio continuation reaches Addressables J55; profiles/platform/menu unproven | Observed initialization, truthful services, optional no-audio lifecycle, Android profile/content roots, original menu navigation | L4/L9 foundation; entitlement/native lifecycle |
