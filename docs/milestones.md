...
| L4 recovered scene | OPEN; L4a reference audit complete | loadingbasic plus dependency-rich animated prefab on device; required GUID/local fileID/script/subasset/catalog audit | L3; serialization; T10 before large data |
