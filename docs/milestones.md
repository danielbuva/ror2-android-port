...
| L4 recovered scene | OPEN; scene/persistent objects and inactive prefab rig pass; visible pose next | loadingbasic plus dependency-rich animated prefab on device; required GUID/local fileID/script/subasset/catalog audit | L3; serialization; T10 before large data |
