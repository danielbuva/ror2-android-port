...
| L5 lawful startup/menu | OPEN — original loading-scene handoff passes J40; component lifecycle next | Observed initialization, truthful services, optional no-audio lifecycle, Android profile/content roots, original menu navigation | L4/L9 foundation; entitlement/native lifecycle |
